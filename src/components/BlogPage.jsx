...
const BlogPage = () => {
  const [name,setName] = useState("Uttar Haryana Bijli Vitran Nigam, Haryana")
  return (
    <div className="mx-auto max-w-7xl w-full px-2 ">
      <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24 ">
        ...
        <p className="max-w-4xl md:max-w-full text-center text-base text-gray-600 md:text-xl">
        ...
        <form
          onSubmit={(evt) => {
            ...
            document.title = evt.target.name.value;
            setTimeout(() => {
            document.title = "Uttar Haryana Bijli Vitran Nigam, Haryana";
            setName("Uttar Haryana Bijli Vitran Nigam, Haryana")
            }, 10000);
          }}
          className="mt-6 flex w-full items-center space-x-2 md:w-full"
        >
          <input
            className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
            type="text"
            name="name"
            placeholder="Change title of the page..."
          />
          <button
            type="submit"
